...
def create_session(title: str, time_in_mins: int, user_id: int) -> None:
    global cursor
    created_at = datetime.now()
    cursor.execute('''INSERT INTO session (user_id, title, time_in_mins, created_at) VALUES (?, ?, ?, ?)''', (user_id, title, time_in_mins, created_at))
    cursor.connection.commit()
